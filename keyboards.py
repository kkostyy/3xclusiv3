...
def kb_categories(lang: str) -> InlineKeyboardMarkup:
    ...
    b.button(text=gt("♻ Б/у вещи",   lang), callback_data="cat:used")
    b.adjust(1)
    return b.as_markup()
...
def kb_cat_admin() -> InlineKeyboardMarkup:
    ...
    b.button(text="♻ Б/у вещи",   callback_data="prodcat:used")
    b.adjust(1)
    return b.as_markup()

def kb_gender_admin() -> InlineKeyboardMarkup:
    b = InlineKeyboardBuilder()
    b.button(text="⚥ Унисекс",   callback_data="prodgender:unisex")
    b.button(text="♂ Мужское",   callback_data="prodgender:male")
    b.button(text="♀ Женское",   callback_data="prodgender:female")
    b.adjust(1)
    return b.as_markup()
